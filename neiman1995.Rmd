...
group_drift_simulation_data_3 <- eventReactive(
  input$run_button_group_drift_simulation_iter_2, {
    ...
    sqe_m <- c() 
    for (t_m in 1:t_final_group_3) {
      #print(multi_group_matrizes(N_group_3, t_m, Mk_2)$longmosed)
      sqe_m[t_m] <- multi_group_matrizes(N_group_3, t_m, Mk_2, mi_3)$longmosed$value[2]
    }
    
    mixed_list[[2]] <- data.frame(t = 1:t_final_group_3, sed = sqe_m)
