...
The matrix of variances and covariances $\mathbf{V}$ can be converted to a matrix of squared Euclidian distances $d_{ij}^{2(t)}$.
...
The migration matrix approach can be applied to the problem of woodland ceramic diversity by computing a matrix of squared Euclidian distances between the groups for each of the variants. We expect to find that the overall level of differentiation among groups, as measured by the mean of the squared Euclidian distances, is the mirror image of our estimates of $θ$.
